...
@Component({
  selector: "page-prototype-details",
  templateUrl: "prototype-details.html",
  styleUrls: ["./prototype-details.scss"],
})
export class PrototypeDetailsPage implements OnInit {
  ...
  fetchCustomerDetails(customerId) {
    this._userServices
      .getPrototypeDetails(customerId)
